...
# utils
from gnm_train.process_data.process_ros2bags_data_utils import *


def main(args: argparse.Namespace):

    # load the config file
    with open("gnm_train/process_data/process_ros2bags_config.yaml", "r") as f:
    ...
    # iterate recurisively through all the folders
    # get the directory of rosbags in the args.input_dir
    bag_dirs = []
    for root, dirs, files in os.walk(args.input_dir):
      for dir in dirs:
        bag_dirs.append(os.path.join(root, dir))
        # for file in files:
